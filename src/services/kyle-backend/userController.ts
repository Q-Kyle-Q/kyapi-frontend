...
/** downloadSdkHelp GET /api/user/sdkHelp */
export async function downloadSdkHelpUsingGET(options?: { [key: string]: any }) {
  return request<API.BaseResponseboolean>('/api/user/sdkHelp', {
    method: 'GET',
    ...(options || {}),
  });
}
